...
write-skill 是一个用于去除文本中 AI 生成痕迹的工具，帮助你将 AI 生成的内容改写得更自然、更像人类书写的文本。
...
```bash
npx skills add https://github.com/aresbit/write-skill.git
```
...
git clone https://github.com/aresbit/write-skill.git ~/.claude/skills/write-skill
```

### 方法三：手动安装

1. 下载本项目的 ZIP 文件或克隆到本地
2. 将 `write-skill` 文件夹复制到 Claude Code 的 skills 目录：
